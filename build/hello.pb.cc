...
const ::uint32_t
    TableStruct_hello_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::hello::HelloReply, _impl_.message_),
};
...
const char descriptor_table_protodef_hello_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "lloRequest\032\021.hello.HelloReplyb\006proto3"
};
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloReply::_InternalSerialize(
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "hello.HelloReply.message");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
