...
class IDList final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:data.IDList) */ {
 public:
  inline IDList() : IDList(nullptr) {}
  ~IDList() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(IDList* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(IDList));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR IDList(
      ::google::protobuf::internal::ConstantInitialized);

  inline IDList(const IDList& from) : IDList(nullptr, from) {}
  inline IDList(IDList&& from) noexcept
      : IDList(nullptr, std::move(from)) {}
  ...
  IDList* New(::google::protobuf::Arena* arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<IDList>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const IDList& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const IDList& from) { IDList::MergeImpl(*this, from); }
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "data.IDList"; }

 protected:
  explicit IDList(::google::protobuf::Arena* arena);
  IDList(::google::protobuf::Arena* arena, const IDList& from);
  IDList(::google::protobuf::Arena* arena, IDList&& from) noexcept
      : IDList(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::internal::ClassData* GetClassData() const PROTOBUF_FINAL;
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:data.IDList)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline ::int32_t IDList::ids(int index) const {
  // @@protoc_insertion_point(field_get:data.IDList.ids)
  return _internal_ids().Get(index);
}
inline void IDList::set_ids(int index, ::int32_t value) {
  _internal_mutable_ids()->Set(index, value);
  // @@protoc_insertion_point(field_set:data.IDList.ids)
}
inline void IDList::add_ids(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_ids()->Add(value);
  // @@protoc_insertion_point(field_add:data.IDList.ids)
}
inline const ::google::protobuf::RepeatedField<::int32_t>& IDList::ids() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:data.IDList.ids)
  return _internal_ids();
}
inline ::google::protobuf::RepeatedField<::int32_t>* IDList::mutable_ids()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:data.IDList.ids)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_ids();
}
inline const ::google::protobuf::RepeatedField<::int32_t>&
IDList::_internal_ids() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.ids_;
}
inline ::google::protobuf::RepeatedField<::int32_t>* IDList::_internal_mutable_ids() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.ids_;
}
